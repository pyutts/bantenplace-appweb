                        ...
                        <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active rounded">
                                    <img src="<?= base_url('home');?>/img/hero-img-1.jpg" class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                ...
                                <div class="carousel-item rounded">
                                    <img src="<?= base_url('home');?>/img/hero-img-3.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Banten Manusa Yadnya</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="<?= base_url('home');?>/img/hero-img-4.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
                                    <a href="#" class="btn px-4 py-2 text-white rounded">Banten Pitra Yadnya</a>
                                </div>
                                <div class="carousel-item rounded">
                                    <img src="<?= base_url('home');?>/img/hero-img-5.jpg" class="img-fluid w-100 h-100 rounded" alt="Second slide">
